...
import { CorpBaseResearchName, CorpProductResearchName } from "corporation/enums"

/** A record for looking up a research object from the name */

export const researches = {}

researches[CorpBaseResearchName.AutoBrew] = {
   name: "AutoBrew",
   cost: 12e3,
   desc:
...
researches[CorpBaseResearchName.AutoParty] = {
...
researches[CorpBaseResearchName.AutoDrug] = {
...
researches[CorpBaseResearchName.CPH4Inject] =
{
...
researches[CorpBaseResearchName.Drones] =
{
   name: "Drones",
   cost: 5e3,
   desc:
...
researches[CorpBaseResearchName.DronesAssembly] = {
...
researches[CorpBaseResearchName.DronesTransport] = {
   ...
   researches[CorpBaseResearchName.GoJuice] = {
      name: "Go-Juice",
      cost: 25e3,
      desc:
   ...
   researches[CorpBaseResearchName.RecruitHR] = {
   ...
   researches[CorpBaseResearchName.TrainingHR] = {
   ...
   researches[CorpBaseResearchName.Lab] = {
   ...
   researches[CorpBaseResearchName.MarketTa1] = {
      name: "Market-TA.I",
      cost: 20e3,
      desc:
   ...
   researches[CorpBaseResearchName.MarketTa2] = {
      name: "Market-TA.II",
      cost: 50e3,
      desc:
   ...
   researches[CorpBaseResearchName.Overclock] = {
      name: "Overclock",
      cost: 15e3,
      desc:
   ...
   researches[CorpBaseResearchName.SelfCorrectAssemblers] = {
   ...
   researches[CorpBaseResearchName.Stimu] = {
      name: "Sti.mu",
      cost: 30e3,
      desc:
...
researches[CorpProductResearchName.Capacity2] = {
...
researches[CorpProductResearchName.Dashboard] = {
...
researches[CorpProductResearchName.Fulcrum] = {
